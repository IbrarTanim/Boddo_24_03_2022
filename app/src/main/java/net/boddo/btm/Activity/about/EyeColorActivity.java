...
public class EyeColorActivity extends AppCompatActivity {

    EyeColorActivity activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!Data.userEyeColor.equals("")) {
            String userEyeColor = Data.userEyeColor;
            switch (userEyeColor) {
                case "Ask Me":
    ...
    public static Intent newIntent(Context context) {
        Intent intent = new Intent(context, EyeColorActivity.class);
        return intent;
    }
}
